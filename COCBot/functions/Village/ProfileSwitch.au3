Func ProfileSwitch()
	...
	$ichkDESwitchMax = 1 Or $ichkDESwitchMin = 1 Or $ichkTrophySwitchMax = 1 Or $ichkTrophySwitchMin = 1 Then
		...
		If $SwitchtoProfile <> "" Then
				TrayTip($sModeText[$iMatchMode] & " Village Report!", "Gold: "  & _NumberFormat($iGoldCurrent) & "; Elixir: " &  _NumberFormat($iElixirCurrent) & "; Dark: " &  _NumberFormat($iDarkCurrent) & "; Trophy: " & _NumberFormat($iTrophyCurrent), "", 0)
