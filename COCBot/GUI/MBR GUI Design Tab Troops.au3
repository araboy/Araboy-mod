...
$sTxtEarthQuake = GetTranslated(1,65, "EarthQuake")
...
$tabTroops = GUICtrlCreateTabItem(GetTranslated(1,1, "Troops"))
	...
	$y = 150
	$x +=155
	$grpSpells = GUICtrlCreateGroup(GetTranslated(1,47, "Add. Dark Troops"), $x - 20, $y - 20, 145, 175)
	...
	$x += 150
	$y = 330
	$grpDarkTroops = GUICtrlCreateGroup(GetTranslated(1,54, "Spells"), $x - 20, $y - 20, 150, 195)
...
#ce		$lblFreezeS = GUICtrlCreateLabel("x", $x + 112, $y, -1, -1)
		...
		$lblEarthquakeSpell = GUICtrlCreateLabel($sTxtEarthQuake & ":", $x + 20, $y, -1, -1)
		$txtNumEarthquakeS = GUICtrlCreateInput("0", $x + 80, $y - 3, 30, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER))
			GUICtrlSetTip(-1, $sTxtSetPerc3 & " " & $sTxtEarthQuake & " " & $sTxtSetSpell)
			GUICtrlSetLimit(-1, 2)
